...
| `lib/GerenteViewConsorcio.js` | Espelha `GerenteView.js` pro segmento **consórcio** — dentro, renderiza `ConsorcioDashboard`. Fonte de vendas é `crm_leads`/`consorcio_goals` em vez de `sales_entries`/`sales_goals` |
