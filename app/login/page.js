    ...
    <main className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-muted mb-2">Sua empresa ainda não tem acesso?</p>
          <a
            href="https://wa.me/5511953893938?text=Ol%C3%A1!%20Quero%20saber%20mais%20sobre%20o%20Z%20Meta%20para%20minha%20empresa."
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 text-white rounded-full px-5 py-2.5 text-sm font-bold tracking-wide active:scale-95 transition-all shadow-pop w-full"
