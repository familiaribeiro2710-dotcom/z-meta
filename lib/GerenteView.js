...
export default function GerenteView({ profile, tab, viewedBySupervisor = false, onBack }) {
  ...
  // (localStorage, mesmo padrão do goalCelebrations do colaborador em ColaboradorView.js). Só roda
  // na sessão real do gerente (nunca em "ver como" — o supervisor não deve ver o parabéns do
  // gerente) e só pro mês corrente — meta de mês fechado não gera pop-up.
  useEffect(() => {
