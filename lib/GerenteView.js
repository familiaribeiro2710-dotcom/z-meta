        ...
        <>
          ...
          >
            ...
            <div className="relative flex items-center gap-2 mb-3">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-navy">{PACING_HERO_LABEL[activePacing]} · {lojaName || "sua loja"}</span>
            </div>
            ...
            <p className="relative text-xs font-semibold text-navy/70 mt-1">{isCurrentMonth ? "Vendido até hoje" : "Vendido no mês"}: {formatBRL(hero.soldLoja)}</p>

            <div className="relative grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-x-3 gap-y-5 sm:gap-4 mt-6 pt-5 border-t border-navy/15">
