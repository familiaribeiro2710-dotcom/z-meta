...
export default function LandingPage() {
  return (
    <main className="min-h-screen bg-paper">
      {/* Sobrescreve o gradiente roxo/rosa/teal de fundo que app/globals.css aplica em html/body
          pra todo o app (sutil nas telas internas, mas fica evidente/rosado numa landing com
          seções grandes e vazias). O roxo→rosa é reservado só pra comemoração — aqui a página
          precisa ficar só no navy + dourado. */}
