...
export default function LandingPage() {
  return (
    <main className="min-h-screen overflow-x-hidden">
      ...
      <section className="max-w-3xl mx-auto px-5 sm:px-6 py-14 sm:py-20 text-center">
        <p className="text-xs font-bold uppercase tracking-wider text-gold mb-5 sm:mb-6">Depoimento</p>
