...
export default function Pipeline({ employeeIds, lojaId, employees = [], empresaId, canManage = false, showResponsavel = true, viewerId }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <LeadHistoryPanel lead={historyLead} onClose={() => setHistoryLead(null)} viewerId={viewerId} />
    </div>
  );
}
