...
function baseColumns() {
  ...
  // 2026-09-05 (pedido do Felipe): "Sem contato" saiu do fim da fileira (ao lado de "Perdido") e
  // passou pra logo depois de "Follow-up" — mais perto de onde ela de fato acontece no fluxo (só
  // é alcançável a partir de "Novo", ver `validDropTargets`), em vez de ficar visualmente colada
  // só a outro desfecho negativo.
  return [
    { key: "novo", label: "Novo" },
