        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-navyfixed/70 p-6">
          <div className="card max-w-sm w-full animate-bounce-in">
            ...
            <p className="text-xs text-muted mt-1">
              Vai ser adicionada no histórico de {bulkNoteLeads.length} lead(s) da etapa &ldquo;{bulkNoteCol.label}&rdquo;{filterEmployeeId ? " (respeitando o filtro de colaborador atual)" : ""}.
            </p>
            <div className="mt-4">
