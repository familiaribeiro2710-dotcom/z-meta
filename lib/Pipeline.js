          ...
          return (
            <div key={col.key} className="min-w-[220px] flex-1">
              <div className="flex items-center justify-between gap-2 mb-2 px-0.5">
                <span className="text-[11px] font-extrabold text-navy uppercase tracking-wide">{col.label}</span>
                <span className="bg-line text-navy text-[10px] font-bold px-1.5 py-0.5 rounded-full">{cards.length}</span>
              </div>
              <div
