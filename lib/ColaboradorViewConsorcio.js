    ...
    <div className="space-y-6">
      ...
      {tab === "atividades" && (
        <div className="space-y-6">
          ...
          {activeGoalGeralItem?.goal?.non_monetary_prize && (
            <div className="rounded-xl py-2.5 px-4 bg-pink/10 flex items-center gap-2 reveal-up">
              ...
              <p className="text-xs font-bold text-navy">Prêmio extra ativo este mês: {activeGoalGeralItem.goal.non_monetary_prize}</p>
            </div>
          )}
