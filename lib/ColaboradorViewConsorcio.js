    ...
    <li className="py-3">
      <div className="flex items-start justify-between gap-2 flex-wrap">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          {editable && onEdit && (
            <button type="button" onClick={() => onEdit(lead)} title="Editar cadastro" aria-label="Editar" className="p-1.5 rounded-lg border border-line text-muted hover:border-purple hover:text-purple transition-colors">
              <Edit3 size={14} />
            </button>
          )}
          {canAgendar && (
...
export default function ColaboradorViewConsorcio({ profile, tab, viewedByManager = false, onBack }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {editModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-navy/70 p-6">
          <div className="card max-w-sm w-full max-h-[85vh] overflow-y-auto animate-bounce-in border-purple/30">
            <h2 className="text-lg font-extrabold text-navy flex items-center gap-2"><Edit3 className="text-purple" size={20} /> Editar cadastro</h2>
            <div className="mt-4 space-y-3">
              <div>
          ...
          <div className="card">
            <button type="button" onClick={() => setFiltrosLeadOpen((v) => !v)} className="w-full flex items-center justify-between gap-2">
              <p className="label mb-0 flex items-center gap-1.5">
                <Filter size={14} /> Filtros{filtroLeadAtivo && <span className="badge bg-purple/15 text-purple !text-[10px]">ativo</span>}
              </p>
              ...
              <form onSubmit={aplicarFiltroLeads} className="mt-3 space-y-3">
                ...
                <div className="flex items-center gap-3 pt-1 flex-wrap">
                  ...
                  {(filtroLeadAtivo || filtroLeadPendente) && (
                    <button type="button" onClick={limparFiltroLeads} className="text-[11px] font-bold uppercase tracking-wider text-muted hover:text-purple">
                      Limpar filtros
                    </button>
                  )}
