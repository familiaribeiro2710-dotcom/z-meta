      ...
      <div className="flex items-center gap-1 shrink-0">
        {editable && onEdit && (
          <button
            ...
            aria-label="Editar"
            className="p-1.5 rounded-lg text-white/60 hover:text-goldlight hover:bg-white/10 transition-colors"
          >
            <Edit3 size={14} />
          </button>
        )}
        {canAgendar && (
          <button
            ...
            aria-label="Agendar"
            className="p-1.5 rounded-lg text-white/60 hover:text-bluelight hover:bg-white/10 transition-colors"
          >
            <CalendarPlus size={14} />
          </button>
        )}
      ...
      {prizeCelebrations.length === 0 && !showCongrats && storeGoalCelebrations.length > 0 && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-navy/70 p-6">
          ...
          <div className="card max-w-sm w-full text-center animate-bounce-in border-purple/30">
            ...
            <h2 className="text-xl font-extrabold gradient-text">Parabéns, {profile.full_name.split(" ")[0]}!</h2>
            <p className="text-sm text-muted mt-2 flex items-center justify-center gap-1.5 flex-wrap">
              A loja bateu a <span className="font-bold text-navy">{storeGoalCelebrations[0].name}</span> deste mês! <PartyPopper size={15} className="text-orange" />
            </p>
                    ...
                    {isContatos ? (
                      ...
                      <button
                        ...
                        className={`w-7 h-7 rounded-xl border-2 flex items-center justify-center shrink-0 transition-all font-bold text-white ${
                          done ? "border-transparent animate-bounce-in" : "border-line bg-white hover:border-gold"
