          ...
          <div className="card max-w-sm w-full text-center animate-bounce-in border-purple/30">
            ...
            {storeGoalCelebrations[0].non_monetary_prize && (
              <p className="text-xs font-bold text-navy bg-pink/10 rounded-lg py-2 px-3 mt-3 flex items-center justify-center gap-1.5">
                <PartyPopper size={13} /> Prêmio da equipe: {storeGoalCelebrations[0].non_monetary_prize}
              </p>
            )}
            ...
            <div className="card animate-pop border-orange/20">
              ...
              {activeGoalGeralItem?.goal?.non_monetary_prize && (
                <p className="text-xs font-bold text-navy bg-pink/10 rounded-lg py-2 px-3 mt-2 flex items-center gap-1.5">
                  <PartyPopper size={13} className="shrink-0" /> Prêmio da equipe: {activeGoalGeralItem.goal.non_monetary_prize}
                </p>
              )}
            </div>
          </div>
