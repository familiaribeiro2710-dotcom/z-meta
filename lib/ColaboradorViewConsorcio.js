    ...
    <li className="py-3">
      <div className="flex items-start justify-between gap-2 flex-wrap">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          {editable && onEdit && (
            <button type="button" onClick={() => onEdit(lead)} title="Editar cadastro" aria-label="Editar" className="p-1.5 rounded-xl border border-line text-muted hover:border-purple hover:text-purple transition-colors">
              <Edit3 size={14} />
            </button>
          )}
          {canAgendar && (
            <button type="button" onClick={() => onAgendar(lead)} title="Agendar / reagendar" aria-label="Agendar" className="p-1.5 rounded-xl border border-line text-muted hover:border-blue hover:text-blue transition-colors">
              <CalendarPlus size={14} />
            </button>
          )}
          {canResolve && showResolve && (
            <>
              <button type="button" onClick={() => onResolve(lead, "em_negociacao")} title="Em negociação" aria-label="Em negociação" className="p-1.5 rounded-xl border border-teal/30 text-teal hover:bg-teal/10 transition-colors">
                <Handshake size={14} />
              </button>
              <button type="button" onClick={() => onResolve(lead, "perdido")} title="Perdido" aria-label="Perdido" className="p-1.5 rounded-xl border border-danger/30 text-danger hover:bg-danger/10 transition-colors">
                <XCircle size={14} />
              </button>
              <button type="button" onClick={() => onResolve(lead, "follow_up")} title="Follow-up" aria-label="Follow-up" className="p-1.5 rounded-xl border border-warn/30 text-warn hover:bg-warn/10 transition-colors">
                <Clock size={14} />
              </button>
              <button type="button" onClick={() => onResolve(lead, "vendido")} title="Vendido" aria-label="Vendido" className="p-1.5 rounded-xl border border-success/30 text-success hover:bg-success/10 transition-colors">
      ...
      <div className="flex items-center gap-1 shrink-0">
        {editable && onEdit && (
          <button
            ...
            aria-label="Editar"
            className="p-1.5 rounded-xl text-white/60 hover:text-goldlight hover:bg-white/10 transition-colors"
          >
            <Edit3 size={14} />
          </button>
        )}
        {canAgendar && (
          <button
            ...
            aria-label="Agendar"
            className="p-1.5 rounded-xl text-white/60 hover:text-bluelight hover:bg-white/10 transition-colors"
          >
            <CalendarPlus size={14} />
          </button>
        )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-navy/70 p-6">
          ...
          <div className="card max-w-sm w-full text-center animate-bounce-in border-purple/30">
            ...
            {storeGoalCelebrations[0].non_monetary_prize && (
              <p className="text-xs font-bold text-navy bg-pink/10 rounded-xl py-2 px-3 mt-3 flex items-center justify-center gap-1.5">
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div className="relative flex items-center gap-2 mb-3">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-navy">{activePacing === "dia" ? "Falta pra bater a meta" : PACING_HERO_LABEL[activePacing]}</span>
            </div>
            <AutoFitText className="relative text-4xl sm:text-5xl font-extrabold text-navy leading-tight">{formatBRL(heroTarget)}</AutoFitText>
            ...
            <div className="relative grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-x-3 gap-y-5 mt-6 pt-5 border-t border-navy/15">
              <div className="min-w-0">
