...
export default function ColaboradorViewConsorcio({ profile, tab, viewedByManager = false, onBack }) {
  ...
  // Meta em jogo (o item, não só o número) — usado só pra mostrar o prêmio não-monetário dessa
  // camada, se tiver (mesmo padrão de ColaboradorView.js/activeGoalItem, vestuário).
  ...
  return (
    <div className="space-y-6">
      ...
      {!showCongrats && closingWinners.length > 0 && (
      ...
      {tab === "atividades" && (
        <div className="space-y-6">
          ...
          >
            ...
            {activeGoalItem?.goal?.non_monetary_prize && (
              <p className="relative text-xs font-bold text-navy mt-1 flex items-center gap-1.5">
                <PartyPopper size={13} /> Prêmio da equipe: {activeGoalItem.goal.non_monetary_prize}
              </p>
            )}
