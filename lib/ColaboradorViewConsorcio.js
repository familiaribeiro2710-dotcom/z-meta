...
export default function ColaboradorViewConsorcio({ profile, tab, viewedByManager = false, onBack }) {
  ...
  const [draftStatusesLead, setDraftStatusesLead] = useState(allLeadStatusesOn);
  ...
  const [filtroStatusesLead, setFiltroStatusesLead] = useState(allLeadStatusesOn);
  ...
  const filtroLeadAtivo = !!(filtroDataIniLead || filtroDataFimLead || filtroCategoriaLead || buscaLead.trim() || LEAD_STATUS_OPTIONS.some((s) => !filtroStatusesLead[s.key]));
  ...
  function limparFiltroLeads() {
    ...
    setDraftDataIniLead(""); setDraftDataFimLead(""); setDraftCategoriaLead(""); setDraftBuscaLead(""); setDraftStatusesLead(all);
    setFiltroDataIniLead(""); setFiltroDataFimLead(""); setFiltroCategoriaLead(""); setBuscaLead(""); setFiltroStatusesLead(all);
  }
