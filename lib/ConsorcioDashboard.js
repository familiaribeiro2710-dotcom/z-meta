...
function Funil({ leads, leadsThisMonth, funilBoard, employees, viewerRole, month, produtoCategorias, empresaId, canManageCategorias, onChanged }) {
  ...
  // Filtro de colaborador (via chip clicável na lista, não um select) + busca livre por nome/telefone
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card-dark">
        <p className="label-dark mb-3 flex items-center gap-1.5"><PhoneCall size={14} className="text-goldlight" /> Leads{filtroAtivo || filtroColaboradorId ? " (filtrado)" : ""}</p>
