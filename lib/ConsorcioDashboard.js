...
export function LeadsTab({ employees, lojaId, empresaId, viewerId, canManage = true }) {
  ...
  const load = useCallback(async () => {
    ...
    const { data } = await supabase
      .from("crm_leads")
      .select("id, employee_id, empresa_id, loja_id, nome_completo, telefone, status, data_ligacao, agendamento_at, valor, categoria_produto_id, feedback, observacoes, created_at")
  ...
  function resetForm() {
    ...
    setFDataLigacao(todayStr()); setFAgendaData(""); setFAgendaHora(""); setFFeedback(""); setFAssignTo(""); setFormMsg("");
  }
