                  ...
                  <div className="flex items-start justify-between gap-2 flex-wrap">
                    ...
                    {l.status === "vendido" && manageableLojaIds.has(l.loja_id) && (
                      <div className="flex items-center gap-1.5 shrink-0">
                        <button type="button" onClick={() => openEdit(l)} title="Editar venda" aria-label="Editar" className="p-1.5 rounded-xl border border-line text-muted hover:border-blue hover:text-blue transition-colors">
                          <Edit3 size={14} />
                        </button>
                      </div>
                    )}
                      ...
                      <div className="mt-2 space-y-3">
                        ...
                        <div className="flex items-center gap-1">
                          <button
                            ...
                            className={`p-1.5 rounded-xl hover:bg-line/60 transition-colors ${sup.active ? "text-muted hover:text-navy" : "text-danger"}`}
                          >
                            <Power size={14} />
                          </button>
                        </div>
