          ...
          <>
            ...
            {(tab === "atividades" || tab === "metas") && (
              <>
                ...
                {/* 2026-07-27 (pedido do Felipe): Agenda de hoje precisa ser o primeiro dashboard
                    da Início/Funil — antes do <ConsorcioDashboard> (Funil/Conversão/etc.), não
                    depois. */}
                ...
                {/* 2026-07-27: card de Conversão daqui foi removido — era duplicado byte-a-byte
                    ...
                    O card "Agenda de hoje" que morava aqui embaixo subiu pra antes do
                    <ConsorcioDashboard> (ver acima) — precisa ser o primeiro dashboard da tela. */}
              </>
            )}
