          ...
          <>
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                <label className="flex items-center gap-1.5 bg-white border-2 border-purple/30 rounded-full pl-3 pr-2.5 py-1.5 shadow-soft hover:border-purple/60 transition-colors cursor-pointer min-w-0 flex-1">
                  <Store size={14} className="text-purple shrink-0" />
                  <span className="relative min-w-0 flex-1">
                    <select
                      className="appearance-none !border-0 !bg-transparent !py-0 !pl-0 !pr-4 !shadow-none !ring-0 text-xs font-bold text-navy focus:outline-none cursor-pointer w-full min-w-0"
