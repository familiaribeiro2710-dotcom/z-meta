...
export default function HierarchyHome({ role, impersonate, viewerProfile, onExitImpersonation }) {
  ...
  if (viewingEmployee) {
    return (
      <AppShell userName={shellName} userId={shellId} userUsername={shellUsername} onNameChange={shellOnNameChange} tabs={EMPRESA_TABS} activeTab={tab === "atividades" || tab === "metas" ? tab : "atividades"} onTabChange={setTab}>
        {impersonationBanner}
