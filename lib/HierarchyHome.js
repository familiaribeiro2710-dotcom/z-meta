...
export default function HierarchyHome({ role, impersonate, viewerProfile, onExitImpersonation }) {
  ...
  const tabs = [
    ...BASE_TABS.slice(0, 2),
    ...(categoriaSlug !== "consorcio" ? [{ key: "online", label: "Online", Icon: Globe }] : []),
    ...
    ...(categoriaSlug === "consorcio" ? [{ key: "pipeline", label: "Pipeline", Icon: Kanban, hideOnMobile: true }, { key: "leads", label: "Leads", Icon: Users }] : []),
    ...BASE_TABS.slice(2),
    ...(categoriaSlug === "consorcio" ? [{ key: "vendas", label: "Vendas", Icon: Coins }] : []),
    ...(role === "socio" ? [{ key: "supervisores", label: categoriaSlug === "consorcio" ? "Hierarquia" : "Supervisores", Icon: ShieldCheck }] : []),
  ];
      ...
      <div className="space-y-6">
        ...
        {role === "supervisor" && !impersonate && (
          <MonthClosingAskModal
            ...
            onConfirm={async () => {
              const fn = categoriaSlug === "consorcio" ? "confirm_month_closing_supervisor_consorcio" : "confirm_month_closing_supervisor";
