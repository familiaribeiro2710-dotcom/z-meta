...
import { calcIndividualPct, formatBRL } from "./scoring";
          ...
          <>
            <div className="flex items-start justify-between gap-3 flex-wrap">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <select
                  className="input !py-1.5 !text-xs !w-auto bg-white/70 border-2 border-line rounded-full px-3"
              ...
              <>
                {tab === "atividades" && (
                  ...
                  >
                    ...
                    <div className="relative grid grid-cols-2 sm:grid-cols-5 gap-4 mt-6 pt-5 border-t border-white/20">
                      <div>
                      ...
                      <div>
                        ...
                        {hero.metaLoja > 0 && <p className="text-[10px] text-white/70 mt-0.5">{hero.commissionPct}% · {hero.commissionTierLabel}</p>}
                      </div>
                      <div>
                    ...
                    <div className="relative mt-5 pt-4 border-t border-white/20">
                      <p className="text-[11px] font-bold uppercase tracking-wider text-white/80 mb-1.5">Barra da loja — vendido / meta</p>
                      <ProgressBar pct={hero.barPct} />
                    </div>
                  </div>
                )}
