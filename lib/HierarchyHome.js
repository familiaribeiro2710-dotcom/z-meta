          ...
          <>
            <div className="space-y-3">
              ...
              {/* seletor de loja só faz sentido nas abas que mostram dado de UMA loja por vez
                  (Início/Metas/Online) — Rankings e Faturamento agregam todas as lojas de uma vez, e
                  Supervisores nem usa loja ou mês, então nenhum dos dois aparece lá. */}
              {(tab === "atividades" || tab === "metas" || tab === "online" || tab === "rankings" || tab === "faturamento") && (
                <div className="flex items-center gap-2">
                  {(tab === "atividades" || tab === "metas" || tab === "online") && (
                    <SelectField
                      icon={Store}
                      className="flex-1"
