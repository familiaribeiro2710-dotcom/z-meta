...
export default function HierarchyHome({ role, impersonate, viewerProfile, onExitImpersonation }) {
  ...
  const tabs = [
    ...
    ...(categoriaSlug === "consorcio" ? [{ key: "pipeline", label: "Pipeline", Icon: Kanban, hideOnMobile: true }] : []),
    ...BASE_TABS.slice(2),
        ...
        {lojas.length === 0 ? (
          ...
          <>
            <div className="space-y-3">
              ...
              {(tab === "atividades" || tab === "metas" || tab === "online" || tab === "rankings" || tab === "faturamento" || tab === "pipeline") && (
                <div className="flex items-center gap-2">
                  {(tab === "atividades" || tab === "metas" || tab === "online" || tab === "pipeline") && (
                    <SelectField
                      icon={Store}
                      className="flex-1"
            ...
            {/* 2026-08-09: "pipeline" entrou aqui — sem isso, o <ConsorcioDashboard>/<EmpresaDashboard>
                ...
                ficar acessível também com tab === "pipeline". */}
            {(tab === "atividades" || tab === "metas" || tab === "pipeline") && (
              <>
