...
const SECTIONS = [
  ...
  { key: "premiacoes", label: "Premiações por colaborador", desc: "Coluna de premiações lançadas pra colaboradores cadastrados (inclusive o prêmio do mês validado na aba Atividades)." },
