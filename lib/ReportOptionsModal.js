...
const SECTIONS = [
  ...
  { key: "colaboradores", label: "Faturamento e comissão por colaborador", desc: "Vendido, % de comissão, comissão e advertências de cada um." },
  { key: "premiacoes", label: "Premiações por colaborador", desc: "Premiações lançadas pra colaboradores cadastrados (inclusive o prêmio do mês validado na aba Atividades) — entra como coluna na tabela de comissão, ou como tabela própria se você desmarcar \"Faturamento e comissão por colaborador\"." },
  { key: "comissaoGerente", label: "Comissão do(s) gerente(s)", desc: "Base de cálculo e valor da comissão de cada gerente da loja." },
  { key: "avulsos", label: "Premiações avulsas", desc: "Premiações pra quem não tem cadastro no sistema (ex.: estoquista). Só aparece se houver alguma no mês." },
