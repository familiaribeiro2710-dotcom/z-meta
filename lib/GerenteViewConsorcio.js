...
// mais abaixo (bloco `tab !== "calendario" && tab !== "leads" && tab !== "vendas"`), que já escopa
// o Pipeline pela equipe do gerente (employeeIds) em vez da loja inteira quando viewerRole="gerente".
