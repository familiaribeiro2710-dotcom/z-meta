...
function VendasTab({ teamEmps, profile }) {
  ...
  const [confirmAprovar, setConfirmAprovar] = useState(null);
      ...
      {recusarModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-navy/70 p-6">
          <div className="card max-w-sm w-full animate-bounce-in border-danger/30">
            ...
            <p className="text-[11px] text-muted mt-2">O colaborador será avisado com esse motivo. A venda volta pra fila dele como follow-up.</p>
            <div className="flex gap-2 mt-5">
