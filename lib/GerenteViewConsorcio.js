...
export default function GerenteViewConsorcio({ profile, tab, viewedBySupervisor = false, onBack }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {tab === "vendas" && <VendasTab teamEmps={teamEmps} />}
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted mt-1">
          Só visualização — aprovar, recusar ou editar uma venda pendente é exclusivo do administrativo.
        </p>
      </div>
