                        ...
                        <li key={t.id} className="flex items-center gap-3 py-2 text-sm">
                          {isContatos ? (
                            <span
                              ...
                              className={`w-6 h-6 rounded-xl flex items-center justify-center shrink-0 font-bold text-white transition-all ${done ? "" : "bg-blue/15 text-blue"}`}
                            ...
                            <button
                              ...
                              className={`w-6 h-6 rounded-xl flex items-center justify-center shrink-0 font-bold text-white transition-all ${done ? "" : "bg-line text-muted hover:bg-line/70"}`}
                              style={done ? { background: "linear-gradient(135deg, #84cc16, #0d9488)" } : undefined}
                            >
