  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card">
        ...
        <p className="text-[11px] text-muted mb-3">{canEdit ? "Você pode marcar ou corrigir tarefas de qualquer dia, inclusive dias anteriores. Só aparecem aqui as tarefas que valem nesse dia." : "Só aparecem aqui as tarefas que valem nesse dia."}</p>
        <ul className="divide-y divide-line">
          {dueTasks.map((t) => {
