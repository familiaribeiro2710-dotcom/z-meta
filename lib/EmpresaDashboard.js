    ...
    <div className="space-y-6">
      ...
      {tab === "atividades" && (
        <div className="space-y-6">
          ...
          {atSub === "colaboradores" && <Colaboradores employees={employees} empresaId={empresaId} onChanged={refresh} />}
...
function Colaboradores({ employees, empresaId, onChanged }) {
  ...
  async function handleCreate(e) {
    ...
    const res = await fetch("/api/admin/create-employee", {
      ...
      body: JSON.stringify({ fullName, password, empresaId }),
    });
