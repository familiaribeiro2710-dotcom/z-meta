...
import { todayStr, firstDayOfMonth, monthLabel, isTaskDueOn, WEEKDAY_LABELS, daysElapsedInMonth, daysInMonth } from "./date";
      ...
      <div className="card">
        <div className="flex items-center justify-between gap-2 mb-3 flex-wrap">
          ...
          <span className="text-sm font-bold text-purple whitespace-nowrap">
            Total: {formatBRL(prizes.reduce((s, p) => s + Number(p.amount || 0), 0))}
          </span>
        </div>
