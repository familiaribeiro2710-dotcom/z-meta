...
export default function EmpresaDashboard({ lojaId, empresaId, viewerRole = "master_admin", tab = "atividades", month: monthProp, onOpenEmployee }) {
    ...
    <div className="space-y-6">
      {tab === "atividades" && (
        <div className="space-y-6">
          ...
          {atSub === "colaboradores" && (
            <Colaboradores employees={employees} empresaId={empresaId} lojaId={lojaId} onChanged={refreshTeam} onOpenEmployee={onOpenEmployee} />
          )}
          {atSub === "tarefas" && (
...
function Colaboradores({ employees, empresaId, lojaId, onChanged, onOpenEmployee }) {
  ...
  async function handleCreate(e) {
    ...
    const res = await fetch("/api/admin/create-employee", {
      ...
      body: JSON.stringify({ fullName, username: username.trim() || undefined, empresaId, lojaId }),
    });
