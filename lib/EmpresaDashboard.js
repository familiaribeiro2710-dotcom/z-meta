    ...
    <div className="space-y-6">
              ...
              <li key={g.id} className="flex items-center justify-between gap-3 py-2.5 text-sm flex-wrap">
                {editingGerenteId === g.id ? (
                  <div className="flex items-center gap-2 flex-1 flex-wrap">
                    <input className="input !py-1.5 !text-sm w-40" value={editGerenteName} onChange={(e) => setEditGerenteName(e.target.value)} placeholder="Nome completo" maxLength={40} autoFocus />
      ...
      <div className="card">
        ...
        <form onSubmit={handleCreate} className="grid sm:grid-cols-2 gap-4">
          <div>
            <label className="label">Nome completo</label>
            <input className="input" value={fullName} onChange={(e) => setFullName(e.target.value)} maxLength={40} required />
          </div>
          <div>
            <label className="label">Usuário (id de login)</label>
        ...
        <ul className="divide-y divide-line">
          {employees.map((emp) => (
            <li key={emp.id} className="flex items-center justify-between gap-3 py-2.5 text-sm flex-wrap">
              {editingId === emp.id ? (
                <div className="flex items-center gap-2 flex-1 flex-wrap">
                  <input className="input !py-1.5 !text-sm w-40" value={editName} onChange={(e) => setEditName(e.target.value)} placeholder="Nome completo" maxLength={40} autoFocus />
