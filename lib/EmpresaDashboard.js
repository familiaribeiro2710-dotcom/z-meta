              ...
              <li key={g.id} className="row-card justify-between flex-wrap">
                ...
                {editingGerenteId !== g.id && (
                  <div className="flex items-center gap-1 shrink-0">
                    ...
                    <button onClick={() => removeEmployee(g)} title="Excluir" aria-label="Excluir" className="p-1.5 rounded-lg text-white/60 hover:text-danger hover:bg-white/10 transition-colors">
                      <Trash2 size={14} />
                    </button>
                  </div>
                )}
            ...
            <li key={emp.id} className="row-card justify-between flex-wrap">
              ...
              {editingId !== emp.id && canEdit && (
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  <button onClick={() => removeEmployee(emp)} title="Excluir" aria-label="Excluir" className="p-1.5 rounded-lg text-white/60 hover:text-danger hover:bg-white/10 transition-colors">
                    <Trash2 size={14} />
                  </button>
                </div>
              )}
