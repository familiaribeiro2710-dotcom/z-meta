        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div className="relative flex items-center gap-2 mb-3">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-navy">{PACING_HERO_LABEL[activePacing]}</span>
            </div>
                      ...
                      <li key={c.id} className="py-2 flex items-center justify-between gap-2">
                        ...
                        {actDashDate === todayStr() && (
                          <div className="flex items-center gap-1 shrink-0">
                            <button type="button" title="Editar" aria-label="Editar" className="p-1.5 rounded-xl text-muted hover:text-navy hover:bg-line/60 transition-colors" onClick={() => openActEdit(c)}>
                              <Pencil size={13} />
                            </button>
                            <button type="button" title="Excluir" aria-label="Excluir" className="p-1.5 rounded-xl text-muted hover:text-danger hover:bg-line/60 transition-colors" onClick={() => setActConfirmDelete(c)}>
                              <Trash2 size={13} />
                            </button>
                          </div>
                        )}
                  ...
                  {onlineSales.map((s) => (
                    <tr key={s.id} className="border-b border-white/10 last:border-0">
                      ...
                      <td className="py-2 text-right whitespace-nowrap">
                        <button type="button" title="Editar" aria-label="Editar" className="p-1.5 rounded-xl text-white/50 hover:text-white hover:bg-white/10 transition-colors" onClick={() => openOnlineEdit(s)}>
                          <Pencil size={13} />
                        </button>
                        <button type="button" title="Excluir" aria-label="Excluir" className="p-1.5 rounded-xl text-white/50 hover:text-danger hover:bg-white/10 transition-colors" onClick={() => setOConfirmDelete(s)}>
                          <Trash2 size={13} />
                        </button>
                      </td>
                    </tr>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-navy/70 p-6">
          <div className="card max-w-sm w-full animate-bounce-in">
            <div className="flex items-center justify-between mb-1">
              ...
              <button type="button" className="p-1.5 rounded-xl text-muted hover:text-navy hover:bg-line/60 transition-colors" onClick={() => setOEditModal(null)}>
                <X size={16} />
              </button>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-navy/70 p-6">
          <div className="card max-w-sm w-full animate-bounce-in">
            <div className="flex items-center justify-between mb-1">
              ...
              <button type="button" className="p-1.5 rounded-xl text-muted hover:text-navy hover:bg-line/60 transition-colors" onClick={() => setActEditModal(null)}>
                <X size={16} />
              </button>
            </div>
            <div className="space-y-3 mt-3">
