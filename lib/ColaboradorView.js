...
import { todayStr, firstDayOfMonth, remainingPeriodsInMonth, PACING_HERO_LABEL, PACING_UNIT, monthLabel, greeting, isTaskDueOn } from "./date";
...
export default function ColaboradorView({ profile, tab, viewedByManager = false, onBack }) {
  ...
  const prizeGoalsAll = storeGoalsList.filter((g) => g.non_monetary_prize);
