            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
              <div>
                ...
                <div className="relative">
                  ...
                  <input className="input !pl-9" placeholder="nome ou telefone" value={busca} onChange={(e) => { setBusca(e.target.value); setPage(0); }} />
                </div>
              </div>
              <div>
                <label className="label">Loja</label>
                <SelectField className="w-full" value={filtroLoja} onChange={(e) => { setFiltroLoja(e.target.value); setPage(0); }}>
              ...
              <div>
                ...
                <SelectField className="w-full" value={filtroEmp} onChange={(e) => { setFiltroEmp(e.target.value); setPage(0); }}>
              ...
              <div>
                ...
                <SelectField className="w-full" value={filtroStatus} onChange={(e) => { setFiltroStatus(e.target.value); setPage(0); }}>
